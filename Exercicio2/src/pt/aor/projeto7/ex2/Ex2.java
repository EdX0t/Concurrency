/*
 *2. Write a program that creates 8 threads and ensures that they run in the following order: 
 2-1-4-3-6-5-8-7. Force the threads to print their identifier, to ensure that they behave as
 intended.
 */
